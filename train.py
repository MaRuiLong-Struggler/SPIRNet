...
from model.SPIRNet import SPIRNet
...
def train():
    ...
    train_dataset = create_dataset.SPIRData(args, is_train=True)
    ...
    test_dataset = create_dataset.SPIRData(args, is_train=False)
